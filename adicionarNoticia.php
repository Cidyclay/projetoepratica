...
function adicionarNoticia($titulo, $imagem, $texto, $video,$link,$id)
{
    ...
    //Eu criei um variável chamada id, para receber um id aleatório que será gerado, toda vez
    // que um post for criado.
        $id = uniqid();
    $data = [
        $titulo,
        $imagem,
...
if (isset($_POST['titulo']) && isset($_POST['imagem']) && isset($_POST['texto']) && isset($_POST['link']) && isset($_POST['id'])) {
    ...
    adicionarNoticia($titulo, $imagem, $texto, $video,$link,$id);
}
